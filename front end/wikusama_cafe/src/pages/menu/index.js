...
/** axios -> library for connect to another server */
...
export default function Menu() {
    ...
    const [id_menu, setIDMenu] = useState(0) // id menu bertipe number
    const [nama_menu, setNamaMenu] = useState("") // nama menu bertipe string
    ...
    /** define state to storoe status of edit */
    ...
    return (
        ...
        style={{backgroundColor: `#FFD9C0`}}>
            <h2 className='d-flex justify-content-center align-item-center'>
                <i className='bi bi-justify'></i> {/** bi -> booststrap icons */}
                Daftar Menu
                </h2>
            <hr />
